/*
  ...
  - You are about to drop the `BarbsershopService` table. If the table is not empty, all the data it contains will be lost.
  - A unique constraint covering the columns `[email]` on the table `User` will be added. If there are existing duplicate values, this will fail.

*/
-- DropForeignKey
ALTER TABLE "BarbsershopService" DROP CONSTRAINT "BarbsershopService_barbershopId_fkey";
